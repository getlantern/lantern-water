...
//
//	mockgen -package=downloader -destination=torrent_reader_mock_test.go github.com/anacrolix/torrent Reader
//
...
func (mr *MockReaderMockRecorder) Seek(offset, whence any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
